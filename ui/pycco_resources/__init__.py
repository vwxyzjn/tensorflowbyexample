...
<div id='container'>
  ...
  <div class='section'>
    ...
    <div class='execution'>
      <a href="{{ ipynb_path }}"><img title="Run code" src="https://raw.githubusercontent.com/vwxyzjn/tensorflowbyexample/master/docs/assets/colab.png" class="run"></a>
    </div>
  </div>
  <div class='clearall'>
  {{#sectionss}}
...
colab_url_prefix = "https://colab.research.google.com/github/vwxyzjn/tensorflowbyexample/blob/master/examples/"
